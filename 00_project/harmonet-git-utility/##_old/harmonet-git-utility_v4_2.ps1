# ==========================================================
# HarmoNet Git Utility v4.2 (Console / Stable)
# Author : Tachikoma
# Purpose: Safe Git operations with menu UI for HarmoNet Phase9
# Changelog v4.2:
#   - Fixed: Git argument passing (string[] array support)
#   - Fixed: Commit message escaping for special characters
#   - Improved: Error handling with return values
#   - Optimized: Removed redundant code in Start-Process and Pause-Menu
# ==========================================================
...
do {
    Clear-Host
    Write-Host "========================================="
    Write-Host "   HarmoNet Git Utility v4.2 (Console)"
    Write-Host "========================================="
