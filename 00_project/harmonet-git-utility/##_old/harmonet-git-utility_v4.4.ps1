# ==========================================================
# HarmoNet Git Utility v4.4 (Console / Stable)
# Author : Tachikoma
# Purpose: Safe Git operations with menu UI for HarmoNet Phase9
# Changelog v4.4:
#   - Added: Auto-detect repository root from script location
#   - Supports flexible script placement within repositories
#   - Inherits all v4.3 improvements
# ==========================================================
