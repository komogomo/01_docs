...
| 区分      | 採用技術                                 | 用途                       |
| ------- | ------------------------------------ | ------------------------ |
| フロントエンド | Next.js 16 / React 19 / TypeScript   | UI実装・API呼出し・多言語UI        |
...
・フロントエンド層：Next.js 16.0.1 (App Router) を採用。
...
| **3.8** | 2025-11-10     | Tachikoma     | **Next.jsのバージョンを更新**               |

Created: 2025-11-07
Last Updated: 2025-11-10
Version: 3.8
Document ID: HN-TECH-STACK-V3.8