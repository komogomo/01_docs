...
| v1.1 | 2025-11-28 | TKD + Claude | テナント可変構造明確化、料金除外、利用規約の掲示板連携追加 |
...
| facilities → facility_rules | 1施設は1つのルール定義を持つ |
| facilities → reservations | 1施設は複数の予約を受ける |
| users → reservations | 1ユーザーは複数の予約を持つ |
