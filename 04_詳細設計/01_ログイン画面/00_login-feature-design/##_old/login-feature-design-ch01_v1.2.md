# HarmoNet 詳細設計書（ログイン画面）ch01 - 画面UI構成 v1.2

**Document ID:** HARMONET-LOGIN-DESIGN-CH01  
**Version:** 1.2  
**Updated:** 2025-11-10  
**Supersedes:** login-feature-design-ch01_v1.1.1.md  
...
本章では、HarmoNetログイン画面の**UI構成・要素配置・共通部品連携構造**を定義する。  
Phase9仕様に準拠し、Magic Link + Passkeyの2認証方式を統合した最終版構成とする。
...
| 認証仕様 | `login-feature-design-ch05_v1.1.md`           | セキュリティ・RLS           |
...
| :------ | :--------- | :------------------------ |
| 1.2     | 2025-11-10 | Corbado SDK対応・Phase9仕様整合化 |
| 1.1.1   | 2025-11-05 | i18n改善・AppHeader統合        |
| 1.1     | 2025-11-03 | 初版（MagicLink + Passkey導入） |
| 1.0     | 2025-10-28 | 初稿                        |

次章 → ch02: 状態管理とフォーム動作仕様