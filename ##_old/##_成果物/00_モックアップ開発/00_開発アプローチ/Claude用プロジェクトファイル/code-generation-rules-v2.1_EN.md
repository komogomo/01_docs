# Code Generation Rules v2.1 (English Edition)
...
1. common.ja.js (Japanese) ✓
2. common.en.js (English) ✓
3. common.zh.js (Chinese) ✓
...
- [ ] Header uses `class="page-header"` (NOT custom Tailwind)
- [ ] Footer uses `class="page-footer"` (NOT custom Tailwind)
- [ ] Header/Footer structure matches home.html template exactly
- [ ] ONLY Layer 2 (content area) customized
- [ ] All 3 feature modules loaded (translator, language-switcher, footer-navigation)
- [ ] JavaScript load order correct (translation data => features => screen logic)
- [ ] No hardcoded language switcher buttons in custom header
- [ ] No custom footer navigation buttons
