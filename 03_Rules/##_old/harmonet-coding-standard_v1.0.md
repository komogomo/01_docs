...
| 項目 | 予定Phase | 内容 |
|------|------------|------|
| v1.1 | Phase10 | 無操作ログアウト・SWRキャッシュ再設計を反映 |
| v1.2 | Phase11 | テスト設計規約（Unit/E2E）追加 |
...
**Supersedes:** None  
**Location:** `/01_docs/03_rules/harmonet-coding-standard_v1.0.md`
